...
date: 2024/02/02
description: 主要介绍如何使用 AWS CloudFront 在内容分发时，对 Nextjs 进行优化，同时简单介绍一些 AWS CloudFront 中缓存相关的设置参数、最佳实践和采坑指南。
tag: aws, nextjs
author: You
---
...
<ImagePreviewer src="/images/nextjs-with-cloudfront/img1.png" alt="how to add Rsc header to AWS CloudFront Cache Identifier"/>
...
<ImagePreviewer src="/images/nextjs-with-cloudfront/img2.png" alt="how to add query params to AWS CloudFront Cache Identifier"/>
...
<ImagePreviewer src="/images/nextjs-with-cloudfront/img3.png" alt="more query params settings"/>

...
date: 2023/06/06
description: 掌握 Functor，等于掌握 FP 的一半，也会对各种以函数式思想为设计理念的工具和类库有一个新的认识。
tag: fp
author: You
---
...
<ImagePreviewer src="/images/the-functor-of-fp/img1.png" alt="the category in category theory"/>

<br />图中的箭头表示映射关系，因此我们可以得出如下结论：

...
date: 2024/03/22
description: 在 EXPO 项目中，使用 AWS IAM 服务实现各类业务场景的实战经验总结。
tag: aws
author: You
---
...
<ImagePreviewer src="/images/aws-expo-summary/img2.png" alt="overview of iam group"/>
...
<ImagePreviewer src="/images/aws-expo-summary/img3.png" alt="overview of iam role"/>
...
<ImagePreviewer src="/images/aws-expo-summary/img1.png" alt="aws iam evaluation under cross-account"/>
...
<ImagePreviewer src="/images/aws-expo-summary/img4.webp" alt="overview of cross-account iam role assuming"/>
